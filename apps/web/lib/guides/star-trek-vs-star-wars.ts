...
export const guideStarTrekVsStarWars: Guide = {
  ...
  sections: [
    {
      heading: 'Runde 1: Picard als Borg gegen Darth Vader',
      body: [
      ...
      productSlugs: ['funko-pop-picard-borg-locutus', 'funko-pop-darth-vader-star-wars'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'left', verdict: 'Picard gewinnt knapp: mehr Gesprächsstoff auf derselben Regalfläche.' },
    },
    {
      heading: 'Runde 2: Enterprise gegen Millennium Falcon im Modellbau',
      body: [
      ...
      productSlugs: ['revell-star-trek-uss-enterprise-ncc-1701-modellbausatz', 'revell-star-wars-millennium-falcon-1-72-modellbausatz'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'draw', verdict: 'Unentschieden. Saubere Linien links, fliegende Werkstatt rechts.' },
    },
    {
      heading: 'Runde 3: Kirk im Transporter gegen Han Solo in Carbonit',
      body: [
      ...
      productSlugs: ['funko-pop-kirk-transporter', 'funko-pop-han-solo-in-carbonite-esb'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'draw', verdict: 'Unentschieden. Kirk kommt gerade erst an, Han wäre gern schon weg.' },
    },
    {
      heading: 'Runde 4: Kommando-Bademantel gegen Jedi-Bademantel',
      body: [
      ...
      productSlugs: ['star-trek-tos-command-bademantel-gold', 'star-wars-jedi-bademantel-braun'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'right', verdict: 'Der Jedi gewinnt. Die Macht ist morgens offenbar günstiger als das Kommando.' },
    },
    {
      heading: 'Runde 5: Enterprise-Tasse gegen Lichtschwert-Tasse',
      body: [
      ...
      productSlugs: ['logoshirt-star-trek-enterprise-crew-tasse', 'paladone-star-wars-lichtschwert-farbwechsel-tasse'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'right', verdict: 'Star Wars gewinnt durch warmes Wasser und billige Spezialeffekte. Kino funktioniert ähnlich.' },
    },
    {
      heading: 'Runde 6: Risiko Star Trek gegen Monopoly Star Wars',
      body: [
      ...
      productSlugs: ['winning-moves-risiko-star-trek-deutsch', 'hasbro-monopoly-star-wars-light-side-deutsch'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'left', verdict: 'Risiko gewinnt für Nerd-Runden. Monopoly gewinnt nur, wenn alle am selben Abend noch heimwollen.' },
    },
    {
      heading: 'Runde 7: Enterprise-Schneidebrett gegen Falcon-Servierbrett',
      body: [
      ...
      productSlugs: ['elbenwald-star-trek-enterprise-schneidebrett-buche', 'picnic-time-star-wars-millennium-falcon-servierbrett'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'left', verdict: 'Enterprise gewinnt durch den saubereren Kaufweg. Der Falcon bleibt König der Käseplatte.' },
    },
    {
      heading: 'Runde 8: Star-Trek-Logo gegen Star-Wars-Logo als Lampe',
      body: [
      ...
      productSlugs: ['numskull-star-trek-3d-logo-leuchte', 'paladone-star-wars-logo-leuchte'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'right', verdict: 'Star Wars gewinnt über Preis und Verfügbarkeit. Sehr imperial, aber effizient.' },
    },
    {
      heading: 'Runde 9: Star-Trek-Cocktails gegen Star-Wars-Kochbuch',
      body: [
      ...
      productSlugs: ['star-trek-cocktails-unendliche-drinks', 'star-wars-das-ultimative-kochbuch'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'draw', verdict: 'Unentschieden: Getränke und Essen gegeneinander auszuspielen wäre gesellschaftlich fahrlässig.' },
    },
    {
      heading: 'Runde 10: Commbadge-Eis gegen Todesstern-Eis',
      body: [
      ...
      productSlugs: ['raven-forge-star-trek-commbadge-eiswuerfelform', 'eiswuerfelform-todesstern-star-wars'],
      duel: { leftLabel: 'Star Trek', rightLabel: 'Star Wars', winner: 'right', verdict: 'Der Todesstern gewinnt. Zum ersten Mal zerstört er etwas Sinnvolles: zu warmen Whisky.' },
    },
    {
      heading: 'Welche Seite passt zu welchem Geschenk?',
      body: [
    ...
    {
      heading: 'Endstand: kein Frieden, aber bessere Geschenke',
      body: [
