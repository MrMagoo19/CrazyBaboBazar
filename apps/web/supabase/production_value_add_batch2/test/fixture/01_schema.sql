-- ============================================================================
-- FIXTURE 01 — Production-aehnliches Schema, Stand NACH Batch 1
-- ============================================================================
-- Abgeleitet aus:
...
--
-- UNTERSCHIED ZUR BATCH-1-FIXTURE: dort fehlten die acht Spalten bewusst, weil
-- 02_migrate_value_add.sql sie anlegen musste. Batch 2 migriert nicht — das
-- Schema ist hier von Anfang an vollstaendig (8/8 Spalten, 2/2 Constraints),
-- genau wie Production am 2026-08-26.
--
