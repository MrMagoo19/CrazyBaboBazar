...
export const guideLegoVsPlaymobil: Guide = {
  ...
  keywords: ['lego vs playmobil', 'lego oder playmobil', 'lego playmobil vergleich', 'lego technic', 'playmobil ritterburg', 'lego todesstern'],
  intro: [
  ...
  sections: [
    {
      heading: 'Runde 1: Ritterburg gegen Ritterburg',
      body: [
      ...
      productSlugs: ['lego-31168-ritterburg', 'playmobil-72113-ritterburg'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'right', verdict: 'Playmobil gewinnt: Die Burg ist hier Spielort statt Bauprojekt und nach UVP die günstigere Wahl.' },
    },
    {
      heading: 'Runde 2: Dinosaurier gegen Dinosaurier',
      body: [
      ...
      productSlugs: ['lego-76976-dinosaurier', 'playmobil-71819-dinosaurier'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'right', verdict: 'Playmobil gewinnt über den Preis: gut die Hälfte der LEGO-UVP für ein Thema, das ohnehin zum Toben gemacht ist.' },
    },
    {
      heading: 'Runde 3: Technic-Baustelle gegen Playmobil-Baustelle',
      body: [
      ...
      productSlugs: ['lego-technic-42215-baustelle', 'playmobil-70441-baustelle'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'right', verdict: 'Playmobil gewinnt für die meisten Kinderzimmer: Die Baustelle soll bespielt werden, und der Preisabstand ist zu groß für ein Unentschieden.' },
    },
    {
      heading: 'Runde 4: Puppenhaus gegen Puppenhaus',
      body: [
      ...
      productSlugs: ['lego-10788-puppenhaus', 'playmobil-70205-puppenhaus'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'left', verdict: 'LEGO gewinnt über den Einstiegspreis: weniger als die Hälfte der Playmobil-UVP für dasselbe Thema.' },
    },
    {
      heading: 'Runde 5: Märchenschloss gegen Märchenschloss',
      body: [
      ...
      productSlugs: ['lego-43297-maerchenschloss', 'playmobil-71845-maerchenschloss'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'left', verdict: 'LEGO gewinnt knapp über die niedrigere UVP – bei einem Thema, das beide Marken gleich gut bedienen.' },
    },
    {
      heading: 'Runde 6: Supersportwagen gegen Supersportwagen',
      body: [
    ...
    {
      heading: 'Runde 7: Film- und Kultauto gegen Film- und Kultauto',
      body: [
      ...
      productSlugs: ['lego-technic-42239-kultauto', 'playmobil-71343-kultauto'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'draw', verdict: 'Unentschieden: LEGO fürs Regal, Playmobil fürs Nachspielen. Der Preisabstand entscheidet hier nur übers Budget, nicht über die bessere Idee.' },
    },
    {
      heading: 'Runde 8: Piraten gegen Piraten',
      body: [
      ...
      productSlugs: ['lego-31387-piraten', 'playmobil-71530-piraten'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'right', verdict: 'Playmobil gewinnt bei gleicher UVP: Piratengeschichten wollen gespielt werden, nicht zuerst gebaut.' },
    },
    {
      heading: 'Runde 9: NASA-Rakete gegen Playmobil-Raumfahrt',
      body: [
      ...
      productSlugs: ['lego-technic-42221-nasa-artemis-sls', 'playmobil-72011-raumfahrt'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'left', verdict: 'LEGO gewinnt: Das Vorbild ist echte Raumfahrt, und das Bauen selbst ist hier die Mission.' },
    },
    {
      heading: 'Runde 10: Das teuerste Finale – Todesstern gegen Playmobils Spitzenset',
      body: [
      ...
      productSlugs: ['lego-star-wars-75419-todesstern', 'playmobil-70890'],
      duel: { leftLabel: 'LEGO', rightLabel: 'Playmobil', winner: 'left', verdict: 'LEGO gewinnt das Finale als Bauprojekt. Fair ist das Duell nur bedingt, denn nach UVP trennt beide Sets der Faktor fünf.' },
    },
    {
      heading: 'Endstand: 5:4 für LEGO – bei einem Unentschieden',
      body: [
