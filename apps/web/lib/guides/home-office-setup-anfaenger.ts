...
export const guideHomeOfficeSetupAnfaenger: Guide = {
  ...
  sections: [
    {
      heading: 'Schritt 1: Der Tisch — Steh-Sitz oder Standard?',
      body: [
    ...
    {
      heading: 'Schritt 2: Der Bildschirm auf Augenhöhe',
      body: [
    ...
    {
      heading: 'Schritt 3: Tastatur und Maus — hier trennt sich die Spreu',
      body: [
    ...
    {
      heading: 'Schritt 4: Beleuchtung — der oft übersehene Faktor',
      body: [
    ...
    {
      heading: 'Schritt 5: Audio — Kopfhörer sind Pflicht, nicht Kür',
      body: [
    ...
    {
      heading: 'Schritt 6: Kabelmanagement und Laden — die stille Aufräumung',
      body: [
    ...
    {
      heading: 'Schritt 7: Notizen und Storage — die analog-digitalen Werkzeuge',
      body: [
    ...
    {
      heading: 'Schritt 8: Wellness am Schreibtisch — für die Physio-Kosten der Zukunft',
      body: [
    ...
    {
      heading: 'Fazit: Setup-Building-Reihenfolge und Budget-Planung',
      body: [
